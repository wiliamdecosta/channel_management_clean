						...
						<div class="tab-content profile-edit-tab-content">
						    <div class="tab-pane in active" id="edit-basic">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" value="<?php echo $FULL_NAME; ?>" class="col-xs-10 col-sm-5" placeholder="Fullname" id="form-field-fullname">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<span class="input-icon input-icon-right">
											<input type="email" value="<?php echo $EMAIL; ?>" id="form-field-email">
