                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">                                            
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input class="form-control" type="text" id="skeyword" name="skeyword" placeholder="Nomor Invoice" />
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input class="form-control" type="text" id="skeyword" name="skeyword" placeholder="Nomor Kontrak" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input class="form-control" type="text" id="skeyword" name="skeyword" placeholder="Nama Mitra" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input class="form-control" type="text" id="skeyword" name="skeyword" placeholder="Status" />
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Dari Tgl. </label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" type="text" id="skeyword" name="skeyword" placeholder="Awal" /> 
                                                </div>
                                                <div class="col-sm-1">
                                                    Sampai Tgl.
                                                </div>
                                                <div class="col-sm-2">
                                                    <input class="form-control" type="text" id="skeyword" name="skeyword" placeholder="Akhir" />
                                                </div>
                                            </div>                                           
