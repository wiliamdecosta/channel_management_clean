...
<thead><tr><th>TEN ID</th><th>Tenant</th><th>Address</th><th>Phone No.</th><th>LIS</th><th>Non POTS</th><th></th></tr></thead>
<tbody>
<?php
$no = 1;
foreach($dt as $k => $r) {
	...
	echo "<td align='right'><a href='".site_url("/ten/nd/".$r->TEN_ID)."'>".number_format($r->JML_ND)."</a></td>";
        echo "<td align='right'><a href='".site_url("/ten/ndnp/".$r->TEN_ID)."'>".number_format($r->JML_NONPOTS)."</a></td>";
