<div id="modal_add_item" class="modal fade" role="dialog" style="z-index:1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" id="form_request_item" method="post" class="form-horizontal">
...
<script type="text/javascript">
    ...
    $("#form_request_item").on('submit', (function (e) {
        e.preventDefault();
        var form = $('#form_request_item');
        //alert(form.valid());
        if(form.valid() == true){
            var data = $(this).serializeArray();
            $.ajax({
                url: "<?php echo site_url('summary/add_list_item');?>",
                type: "POST",
                data: data,
                dataType: "json",
