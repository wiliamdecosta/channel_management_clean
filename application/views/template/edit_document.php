										...
										<div class="col-xs-12">
													<div class="row">
														...
														<div class="col-xs-6">
															...
															<div class="form-group">
																<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Periode </label>
																<div class="col-sm-6">																															
																			<input type="date" name="period" id="doc_period">										
																</div>
															</div>
														<div class="form-group">
															...
															<tr value="<?php echo $content->DOC_ID; ?>" data-id="<?php echo $content->DOC_NAME;?>" class="table_head">
																...
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="red" data-rel="tooltip" data-original-title="Delete" id="delete_row" >
																	...
																	<div class="hidden-md hidden-lg">
																		<div class="inline pos-rel">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																				...
																				<li>
																					<a class="tooltip-error" data-rel="tooltip" title="Delete" id="delete_row">
																										<span class="red">
...
jQuery(function($) {
	...
	$(document).on('click', '#dynamic-table #delete_row', function(e) {
		var id_DOC = $(this).closest('tr').attr('value');
...
$(document).ready(function () {
	...
	function Back2(){
		edit = true;
		$('#submitform2 span').text('Finish Edit');
		jQuery("#all_table").hide(1000);
    ...
    $(document).ready(function () {
		$('#submitform').click(function(){
			...
			if (cek) {
				...
				var doc_perd = $('#doc_period').val();
				
				if ( doc_nama.length == 0  || doc_dscrpt.length == 0  || lang_option.length == 0 || doc_perd.length == 0 ){
					...
					$.ajax({				
					   ...
					   dataType: "html",
						...
						data: {
								...
								lokasi_pks:lokasi_pks, doc_type:doc_type, doc_perd :doc_perd
							},
							success: function (data) {
