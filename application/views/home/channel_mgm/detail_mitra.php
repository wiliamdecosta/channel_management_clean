<div id="content-mitra">
    ...
    <div class="row">
        <div class="col-xs-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" id="form-field-1-1" placeholder="Text Field" class="form-control" value="Amirudin"/>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="col-xs-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" id="form-field-1-1" placeholder="Text Field" class="form-control" value="sigit@telkom.co.id"/>
                </div>
            </div>
            <div class="form-group">
    ...
    <div id="button-form" class="col-lg-offset-8">
