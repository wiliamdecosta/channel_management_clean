<div class='title'>Calculate Step by Step</div>
<?php
...
foreach($dt as $k => $r) {
	...
	echo "<td nowrap><a href='".site_url("/calc/refresh0/".$r->NPK_ID)."'><img src='".image_asset_url('refresh.png')."' width=15 class='refresh' title='".$pgl[$r->PGL_ID]." - ".$r->PERIOD."' /></a>";
	echo "&nbsp;&nbsp;<a href='".site_url("/calc/tostep0/".$r->NPK_ID)."'><img src='".image_asset_url('calculator.png')."' width=15 title='".$pgl[$r->PGL_ID]." - ".$r->PERIOD."' /></a>";
