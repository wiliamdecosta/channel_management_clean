        ...
        <div id="new_batch" style="display: none">
            <div class="col-xs-12">
                <div class="well well-sm">
                    <div class="inline middle blue bigger-150" id="application_form_title">Create Batch Data Payment</div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="input-group">
                                        <label class="control-label bolder blue">Pilih Pelanggan</label>
                                        <?php echo buatcombo_new(
                                            'sl_pgl',
                                            'sl_pgl',
                                            'CUST_PGL',
                                            'PGL_NAME',
...
<script type="text/javascript">
    $(document).ready(function () {
         ...
         jQuery("#grid-table").jqGrid({
                 url:'<?php echo site_url('loaddata/grid_dataPayment');?>',
                 datatype: "json",
                 mtype: "POST",
                 ...
                 colModel: [
                     ...
                     { label: 'Proses', name: 'JOB_CODE', width:305, align:"left", editable:false},
                     { label: 'Nama PGL', name: 'PGL_NAME', width:305, align:"left", editable:false},
                     ...
                     { label: 'Deskripsi', name: 'DESCRIPTION', width:305, align:"left", editable:false}
                 ],
                 width: 1120,
                 //width: '100%',
                 height: '100%',
    ...
    function getSelectedRow() {
        ...
        if (rowKey){
           // alert("Selected row primary key is: " + rowKey);
            ...
            if(c == true){
                $.ajax({
                    url: '<?php echo site_url('loaddata/processBatch_Payment');?>',
...
//                        alert(isi);
					...
					if ((data.length) != 0)
					{
						swal("Success","Batch telah selesai dan berhasil diproses","success");
					} else
					{
						swal("Perhatian",data,"info");	
					}
                    }
                });
            }else{
...
<script type="text/javascript">
    ...
    jQuery("#save_batch" ).click(function() {
        ...
        var thn = $('#tahun').val();
        if(!thn) {
            swal('','Silahkan pilih tahun !!!','warning');
            return false;
        }
        if(val.length == 0){
            swal('','Silahkan pilih periode !!!','warning');
            return false;
        }

        var pgl = $('#sl_pgl').val();
        if(!pgl){
            swal('','Silahkan pilih pelanggan !!!','warning');
            return false;
        }
        ...
        if(c == true){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('loaddata/createBatchPayment');?>',
                data: {
                    periode:val,
                    i_pgl_id:pgl
                },
