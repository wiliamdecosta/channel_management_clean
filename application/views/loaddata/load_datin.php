        ...
        <div id="new_batch" style="display: none">
            <div class="col-xs-12">
                <div class="well well-sm">
                    <div class="inline middle blue bigger-150" id="application_form_title">Create New Data Internet Batch</div>
                </div>
...
//                        jQuery('#process').html('<button type="button" class="btn btn-success btn-round" id="process_batch">" <i class="ace-icon fa fa-floppy-o bigger-120"></i>Proses</button>');
                ...
                caption:"Laporan Batch Data Internet"
    ...
    function getSelectedRow() {
        ...
        if (rowKey){
           // alert("Selected row primary key is: " + rowKey);
            ...
            if(c == true){
                $.ajax({
                    url: '<?php echo site_url('loaddata/processBatch_Datin');?>',
