        ...
        <div id="new_batch" style="display: none">
            <div class="col-xs-12">
                <div class="well well-sm">
                    <div class="inline middle blue bigger-150" id="application_form_title">Create Batch Data NOM</div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
         ...
         jQuery("#grid-table").jqGrid({
                 url:'<?php echo site_url('loaddata/grid_dataNOM');?>',
                 datatype: "json",
                 mtype: "POST",
    ...
    function getSelectedRow() {
        ...
        if (rowKey){
           // alert("Selected row primary key is: " + rowKey);
            ...
            if(c == true){
                $.ajax({
                    url: '<?php echo site_url('loaddata/processBatch_NOM');?>',
...
<script type="text/javascript">
    ...
    jQuery("#save_batch" ).click(function() {
        ...
        if(c == true){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('loaddata/createBatchNOM');?>',
                data: {
                    periode:val,
                    i_pgl_id:pgl
                },
