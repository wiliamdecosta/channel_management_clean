    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Lov Mitra</h4>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        grid.jqGrid({
            ...
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'PGL_ID', key: true, width: 105, sorttype: 'number', editable: true, hidden: true},
                {
                    label: 'Nama Mitra',
                    name: 'PGL_NAME',
                    align: "left",
            ...
            ondblClickRow: function (rowid) {
                ...
                var PGL_NAME = grid.jqGrid('getCell', rowKey, 'PGL_NAME');
                var params = PGL_ID + "#~#" + PGL_NAME;
