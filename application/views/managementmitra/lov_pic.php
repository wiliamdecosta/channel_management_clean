    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Lov PIC</h4>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        grid.jqGrid({
            ...
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'P_PIC_ID', key: true, width: 105, sorttype: 'number', editable: true, hidden: true},
                {
                    label: 'Nama PIC',
                    name: 'PIC_NAME',
                    align: "left",
            ...
            ondblClickRow: function (rowid) {
                ...
                var P_PIC_ID = grid.jqGrid('getCell', rowKey, 'P_PIC_ID');
                var PIC_NAME = grid.jqGrid('getCell', rowKey, 'PIC_NAME');
                var params = P_PIC_ID + "#~#" + PIC_NAME;
