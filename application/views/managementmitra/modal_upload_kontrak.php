<div id="modal_upload_kontrak" class="modal fade" role="dialog" style="z-index:1">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Upload Dokumen Kontrak</h4>
            </div>
            <form role="form" id="uploadform_dokkontrak" name="uploadkontrak" method="post" enctype="multipart/form-data"
