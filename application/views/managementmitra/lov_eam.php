    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Lov EAM</h4>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        grid.jqGrid({
            url: '<?php echo site_url('managementmitra/grid_lov_eam');?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'P_DAT_AM_ID', key: true, width: 105, sorttype: 'number', editable: true, hidden: true},
                {
                    label: 'Nama AM',
                    name: 'AM_NAME',
                    align: "left",
            ...
            ondblClickRow: function (rowid) {
                ...
                var AM_ID = grid.jqGrid('getCell', rowKey, 'P_DAT_AM_ID');
                var AM_NAME = grid.jqGrid('getCell', rowKey, 'AM_NAME');
                var params = AM_ID + "#~#" + AM_NAME;
