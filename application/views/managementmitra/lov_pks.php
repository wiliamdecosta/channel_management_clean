    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Lov PKS</h4>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        grid.jqGrid({
            ...
            datatype: "json",
            mtype: "POST",
            postData : {lokasi_id:<?php echo $lokasi_id;?>},
            colModel: [
                {label: 'ID', name: 'P_MP_PKS_ID', key: true, width: 105, sorttype: 'number', editable: true, hidden: true},
                {
                    label: 'NO PKS',
                    name: 'NO_PKS',
                    align: "left",
            ...
            ondblClickRow: function (rowid) {
                ...
                var P_MP_PKS_ID = grid.jqGrid('getCell', rowKey, 'P_MP_PKS_ID');
                var NO_PKS = grid.jqGrid('getCell', rowKey, 'NO_PKS');
                var params = P_MP_PKS_ID + "#~#" + NO_PKS;
