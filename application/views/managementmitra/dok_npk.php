...
<script type="text/javascript">
    $("#btn_upload_npk").click(function () {
        $.ajax({
            // async: false,
            url: "<?php echo base_url();?>managementmitra/modalUploadNPK",
            type: "POST",
            data: {upload_param: 1, pgl_id:<?php echo $pgl_id;?>},
            success: function (data) {
                $('#upload_npk').html(data);
                $('#modal_upload_npk').modal('show');
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        grid.jqGrid({
            url: '<?php echo site_url('managementmitra/gridNPK');?>',
            datatype: "json",
            mtype: "POST",
            postData: {
            ...
            viewrecords: true,
            rowList: [5, 10, 20],
            sortname: 'P_NPK_ID', // default sorting ID
