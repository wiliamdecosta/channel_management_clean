...
<div class="breadcrumbs" id="breadcrumbs">
    <?php echo getBreadcrumb(array('Workflow Summary','Invoice Form WF')); ?>
</div>
    ...
    <div class="row">
        <div class="widget-box">
            <div class="widget-header widget-header-blue widget-header-flat">
                <h4 class="widget-title lighter"> Invoice Form </h4>
            </div>
                        ...
                        <div class="step-content pos-rel">
                            <div class="step-pane active" data-step="1">
                                ...
                                <form class="form-horizontal" id="sample-form">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">No. Invoice:</label>
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <input type="text" id="invoice_no" name="invoice_no" class="col-xs-12 col-sm-3" readonly />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <input type="text" id="contract_type_code" name="contract_type_code" class="col-xs-12 col-sm-5" readonly />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <input type="text" id="contract_no" name="contract_no" class="col-xs-12 col-sm-4" readonly />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <input type="text" id="mitra_name" name="mitra_name" class="col-xs-12 col-sm-5" readonly />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <textarea class="col-xs-12 col-sm-5" rows="3" id="mitra_address" name="mitra_address" readonly></textarea>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Mitar PIC:</label>
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <input type="text" id="mitra_pic" name="mitra_pic" class="col-xs-12 col-sm-5" readonly />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">NPWP Mitra:</label>
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <input type="text" id="mitra_npwp" name="mitra_npwp" class="col-xs-12 col-sm-5" readonly />
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Jumlah Invoice:</label>
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <input type="text" id="invoice_amount" name="invoice_amount" class="col-xs-12 col-sm-4" style="text-align:right" readonly />
                                            </div>
                                        </div>
                                    </div>
...
<script>    
    ...
    $(function() {           
        ...
        /* mengisi form customer order join invoice */
        $.ajax({
            type: 'POST',
            datatype: "json",
            url: '<?php echo site_url('workflow_parameter/grid_customer_order_invoice');?>',
            ...
            success: function(data) {
                ...
                $("#mitra_address").val( items.MITRA_ADDRESS );
                $("#mitra_npwp").val( items.MITRA_NPWP );
                $("#mitra_pic").val( items.MITRA_PIC );
                $("#invoice_amount").val( items.INVOICE_AMOUNT );
                $("#vat_amount").val( items.VAT_AMOUNT );
            }
        });
