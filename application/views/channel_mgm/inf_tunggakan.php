						...
						<div class="col-sm-12">
							<div class="widget-box transparent">
								<div class="widget-header red widget-header-flat">
									<h4 class="widget-title lighter">
										<!--                    <i class="ace-icon fa fa-money orange"></i>-->
										Detail Info Tunggakan
									</h4>
									<div class="tabbable">
										<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="mytab">
											<li class="tab" id="detail_rinta">
												<a href="javascript:void(0)">Tunggakan POTS</a>
											</li>
											<li class="tab" id="fastels">
												<a href="javascript:void(0)">Tunggakan Data Internet</a>
											</li>								
										</ul>										
									</div>										
								</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#findFilter').click(function(){
            ...
            var mitra = $("#mitra").val();
				if(mitra.length >0){
				$.ajax({
					url: '<?php echo site_url('cm/viewTunggakan');?>',
	...
	$('.tab').click(function (e) {
			...
			var periode = tahunvalue+""+bulanvalue;
                ...
                $.ajax({ 
                    type: 'POST',
                    url: '<?php echo site_url('cm/viewTunggakanDatin');?>',
                    data: $("#filterForm").serialize(),
                    timeout: 10000,
                    async: false,
                    success: function (data) {
