						...
						<div class="col-sm-12">
							<div class="widget-box transparent">
								<div class="widget-header red widget-header-flat">
									<h4 class="widget-title lighter">
										<!--                    <i class="ace-icon fa fa-money orange"></i>-->
										Detail Info Data Source
									</h4>
									<div class="tabbable">
										<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="mytab">
											<li class="tab" id="detail_rinta">
												<a href="javascript:void(0)">Rinta MyCoins</a>
											</li>
											<li class="tab" id="fastels">
												<a href="javascript:void(0)">Rinta ID3AS</a>
											</li>								
										</ul>										
									</div>										
								</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#findFilter').click(function(){
            ...
            var mitra = $("#mitra").val();
				if(mitra.length >0){
				$.ajax({
					url: '<?php echo site_url('cm/viewMycoins');?>',
	...
	$('.tab').click(function (e) {
            ...
            e.preventDefault();
			if( ($('#mitra').val()).length == 0  || ($('#formbulan').val()).length == 0 || ($('#formtahun').val()).length == 0){
			...
			var periode = tahunvalue+""+bulanvalue;
                ...
                $.ajax({ 
                    type: 'POST',
                    url: '<?php echo site_url('cm/viewIdeas');?>',
                    data: $("#filterForm").serialize(),
                    timeout: 10000,
                    async: false,
                    success: function (data) {
