    ...
    $(document).ready(function () {
		...
		var width2 = $("#notif").width();
         jQuery("#grid-table").jqGrid({
                 url: "<?php echo site_url(); ?>cm/gridMyCoins/<?php echo $period;?>/<?php echo $pgl_id;?>/<?php echo $dtsc_id;?>",
                 datatype: "json",
                 mtype: "POST",
                 //colNames:['Inv No','Date', 'Client', 'Amount','Tax','Total','Notes'],
                 colModel: [
                     //{ label: 'ID', name: 'USER_ID', key: true, width:5, sorttype:'number', editable: true,hidden:true },
                     { label: 'ND', name: 'ND', width:110, frozen:true, align:"left", editable:true,editrules : { required: true}},
                     { label: 'Alamat', name: 'ALAMAT_01', width:280, frozen:true, align:"left", editable:true,editrules : { required: true}},
                     { label: 'NAMA PLG', name: 'NAMA', width:250, frozen:true, align:"left", editable:true,editrules : { required: true}},
...
//            multipleSearch: true,
 //           showQuery: true
    ...
    function toExcel() {
        ...
        if(c == true){
            $.ajax({
                url: "<?php echo site_url(); ?>cm/rintasheetCoin/<?php echo $pgl_id;?>/<?php echo $dtsc_id;?>/<?php echo $period;?>",
                data: {},
                type: 'POST',
