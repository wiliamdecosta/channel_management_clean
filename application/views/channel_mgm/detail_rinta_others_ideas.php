    ...
    $(document).ready(function () {
		...
		var width2 = $("#notif").width();
         jQuery("#grid-table").jqGrid({
                 url: "<?php echo site_url(); ?>cm/gridIdeas/<?php echo $period;?>/<?php echo $pgl_id;?>/<?php echo $dtsc_id;?>",
                 datatype: "json",
                 mtype: "POST",
...
//            multipleSearch: true,
 //           showQuery: true
    ...
    function toExcel() {
        ...
        if(c == true){
            $.ajax({
                url: "<?php echo site_url(); ?>cm/rintasheetIdeas/<?php echo $pgl_id;?>/<?php echo $dtsc_id;?>/<?php echo $period;?>",
                data: {},
                type: 'POST',
