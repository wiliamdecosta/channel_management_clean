...
<!--    </div>-->
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">EAM Telkom</label>
                <div class="col-sm-2">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" id="form-field-1-1" placeholder="Nama Mitra" class="form-control col-sm-4" value=""/> 
                </div>
                <div class="col-sm-2">
                    <input type="text" id="form-field-1-1" placeholder="Jabatan" class="form-control col-sm-4" value=""/> 
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" id="form-field-1-1" placeholder="Nama Karyawan" class="form-control col-sm-4" value=""/> 
                </div>
                <div class="col-sm-2">
                    <input type="text" id="form-field-1-1" placeholder="Jabatan" class="form-control col-sm-4" value=""/> 
                </div>
