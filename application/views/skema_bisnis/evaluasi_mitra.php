...
<!--    </div>-->
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Bulan Evaluasi </label>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Tgl Evaluasi Penandatangan BA </label>
                <div class="col-sm-6">
        ...
        <div class="col-xs-12">
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" id="form-field-1-1" placeholder="Nama EAM" class="form-control col-sm-4" value=""/> 
                </div>
                <div class="col-sm-2">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Mitra</label>
                <div class="col-sm-2">
                    <input type="text" id="form-field-1-1" placeholder="Nama PIC Mitra" class="form-control col-sm-4" value=""/> 
                </div>
                <div class="col-sm-2">
                    <input type="text" id="form-field-1-1" placeholder="Jabatan" class="form-control col-sm-4" value=""/> 
                </div>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">CHM</label>
                <div class="col-sm-2">
                    <input type="text" id="form-field-1-1" placeholder="Nama CHM" class="form-control col-sm-4" value=""/> 
                </div>
                <div class="col-sm-2">
                    <input type="text" id="form-field-1-1" placeholder="Jabatan" class="form-control col-sm-4" value=""/> 
                </div>
    ...
    <div id="button-form" class="">
        <span id="group1">
            ...
            <a class="btn btn-white btn-sm btn-info btn-bold">
                Insert/Ketik Pointers Hasil Evaluasi
            </a>
            <a class="btn btn-white btn-sm btn-info btn-bold">
                View Detail BA Evaluasi
            </a>
