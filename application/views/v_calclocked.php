<div class='title'>Locked Formula</div>
<?php
...
echo form_open(site_url('/calc/locked'));
...
foreach($dt as $k => $r) {
	...
	echo "<td nowrap><a href='".site_url("/npk/unlock/".$r->NPK_ID)."' class='unlock' title='".$pgl[$r->PGL_ID]." - ".$r->PERIOD."'>unlock</a>";
	echo "</td>";
	echo "</tr>";
	$no++;
}
