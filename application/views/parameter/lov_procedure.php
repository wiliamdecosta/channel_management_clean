		...
		<div class="modal-content">
			...
			<div class="modal-header no-padding">
				<div class="table-header">
					<span class="form-add-edit-title"> DAFTAR PEKERJAAN WORKFLOW </span>
				</div>
			</div>
			...
			<div class="modal-body">
                ...
                <thead>
                  <tr>
                     ...
                     <th data-column-id="PROCEDURE_CODE">Nama Pekerjaan</th>
...
<script>
    ...
    jQuery(function($) {
        $("#modal_lov_procedure_btn_blank").on(ace.click_event, function() {
        ...
        $("#modal_lov_procedure_grid_selection").bootgrid({
    	     formatters: {
                "opt-edit" : function(col, row) {
                    return '<a href="#'+ $("#modal_lov_procedure_code_val").val() +'" title="Set Value" onclick="modal_lov_procedure_set_value(\''+ row.P_PROCEDURE_ID +'\', \''+ row.PROCEDURE_CODE +'\')" class="blue"><i class="ace-icon fa 	fa-pencil-square-o bigger-130"></i></a>';
                }
             },
    	     rowCount:[5,10],
    		 ajax: true,
    	     ...
    	     responseHandler:function (response) {
       	     ...
       	     url: "<?php echo site_url('parameter/gridLovProcedure');?>",
    	     selection: true,
    	     sorting:true
    	});
    }
