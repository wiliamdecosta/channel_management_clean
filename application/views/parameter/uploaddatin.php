            ...
            <div class="col-sm-6">
                <div class="widget-box">
                    <div class="widget-header">
                        <h4 class="widget-title">Upload Datin</h4>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <form role="form" id="uploadform" name="upload" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <?php if ($prv['UPLOAD'] == "Y") {
                                            echo '<button class="btn btn-xs btn-primary" id="submitForm" type="submit">
...
<script type="text/javascript">
    ...
    $("#uploadform").on('submit', (function (e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo site_url('parameter/datinuploaddo');?>", // Url to which the request is send
