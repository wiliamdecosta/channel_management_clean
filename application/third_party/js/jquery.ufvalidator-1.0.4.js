...
(function($) {
	...
	$.formValidator.defaults = {
		...
		errorDiv		:	'#warn',
		errorMsg		: 	{
								reqString		:	'Complete the required fields !',
								reqDate			:	'Date is <b>not</b> valid!',
								reqNum			:	'Just enter the number !',
								reqMailNotValid		:	'E-mail is <b>not</b> valid!',
								reqMailEmpty		:	'Enter your e-mail !',
								reqSame			:	'Again <b>not</b> the same!',
								reqBoth			:	'Fill in the appropriate fields!',
								reqMin			:	'You must enter a minimum of %1 of characters.'
							},
		customErrMsg	:	'',
		extraBoolMsg	:	'Please check the form carefully!',
		dateSeperator	:	'.',
